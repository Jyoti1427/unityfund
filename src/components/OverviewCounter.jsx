...
const OverviewCounter = () => {
  return (
    ...
    >
      <div className="mx-auto my-4 w-full grid grid-cols-4 divide-x divide-slate-700 bg-white p-2 shadow-lg dark:bg-gray-800 dark:text-white/70 md:max-w-[800px] lg:-translate-y-20 md:p-8">
